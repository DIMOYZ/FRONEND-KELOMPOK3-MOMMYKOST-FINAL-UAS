      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.logoContainer}>
            ...
            />
            <Text style={styles.logoText}>Mommykost Ekonomi</Text>
          </View>
        </View>
