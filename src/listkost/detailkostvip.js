// src/listkost/detailkostvip.js
import React from 'react';
import { View, Text, Image, StyleSheet, SafeAreaView, TouchableOpacity, ScrollView } from 'react-native';
import { useNavigation } from '@react-navigation/native';
import { Ionicons } from '@expo/vector-icons'; // atau pakai 'react-native-vector-icons/Ionicons'

const VIPDetail = ({ route }) => {
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.logoContainer}>
            <Image source={require('../../assets/1.jpg')} style={styles.logoImage} />
            <Text style={styles.logoText}>Mommykost VIP</Text>
          </View>
        </View>
